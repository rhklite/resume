...
\begin{cventries}
	...
	{}
	{
		\begin{cvitems}
			\item {
				\textbf{Path Planning} Developed, published, and patented a Delaunay Triangulation based spatial constraint generation algorithm for mapless autonomous vehicle navigation in a dynamic environment
			}
			\item {
				\textbf{Algorithm} Overcame the limitations of existing methods by predicting and adapting to the changes in the triangulation graph
			}
			\item {
				\textbf{Development} Implemented Hybrid A* and Funnel algorithm for path planning in triangulation mesh
			}
			\item{
				\textbf{Analysis} Achieved faster, safer and more robust navigation compared to existing methods in real and simulated navigation datasets
			}
			\item {
				\textbf{Simulation} Engaged in an autonomous driving simulator development using real datasets
			}
			% \item{
