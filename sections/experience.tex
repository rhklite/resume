...
\begin{cventries}
	...
	{}
	{
		\begin{cvitems}
			...
			\item {
				\textbf{Infrastructure} Building and refactoring a containerized, distributed and scalable reinforcement learning pipeline using IsaacGym, Pytorch and Raylib. 
			}
		\end{cvitems}
	}
	\cventry
